            ...
            else
            {
                ...
                do {
                    if (fgets(str, 1023, stdin))
                    {
                        ...
                        {
                            Ogmacam_IoControl(g_hcam, 0, OGMACAM_IOCONTROLTYPE_SET_TRIGGERSOURCE, trigger_source, NULL);
							if (2 == trigger_source)
								Ogmacam_IoControl(g_hcam, trigger_source, OGMACAM_IOCONTROLTYPE_SET_GPIODIR, 0, NULL);
                            break;
                        }
                    }
                } while (true);
