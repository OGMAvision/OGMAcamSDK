...
Public Class Form1
    Private Delegate Sub DelegateEvent(evt As Ogmacam.eEVENT())
    Private cam_ As Ogmacam = Nothing
    ...
    Private Sub DelegateOnEvent(evt As Ogmacam.eEVENT())
    ...
    Private Sub DelegateOnEventCallback(evt As Ogmacam.eEVENT)
        ' this is called by internal thread of ogmacam.dll which Is Not the same of UI thread.
        ' Why we use BeginInvoke, Please see:
        ' http//msdn.microsoft.com/en-us/magazine/cc300429.aspx
        ' http://msdn.microsoft.com/en-us/magazine/cc188732.aspx
        ' http://stackoverflow.com/questions/1364116/avoiding-the-woes-of-invoke-begininvoke-in-cross-thread-winform-event-handling
        BeginInvoke(ev_, New Ogmacam.eEVENT() {evt})
    End Sub
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.trackBar2.SetRange(Ogmacam.TEMP_MIN, Ogmacam.TEMP_MAX)
        Me.trackBar3.SetRange(Ogmacam.TINT_MIN, Ogmacam.TINT_MAX)
    End Sub
    ...
    Private Sub OnStart(sender As Object, e As EventArgs) Handles button1.Click
        ...
        Dim arr As Ogmacam.DeviceV2() = Ogmacam.[EnumV2]()
        ...
        If cam_ IsNot Nothing Then
            ...
            If cam_.get_eSize(eSize) Then
                ...
                If cam_.get_Size(width, height) Then
                    ...
                    If Not cam_.StartPullModeWithCallback(New Ogmacam.DelegateEventCallback(AddressOf Me.DelegateOnEventCallback)) Then
            ...
            If cam_.get_eSize(eSize) Then
                If eSize <> comboBox1.SelectedIndex Then
                    ...
                    If cam_.get_Size(width, height) Then
                        bmp_ = New Bitmap(width, height, PixelFormat.Format24bppRgb)
                        ev_ = New DelegateEvent(AddressOf Me.DelegateOnEvent)
                        cam_.StartPullModeWithCallback(New Ogmacam.DelegateEventCallback(AddressOf Me.DelegateOnEventCallback))
                    End If
                End If
            End If
        End If
