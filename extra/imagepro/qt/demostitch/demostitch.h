...
class MainWindow : public QMainWindow
{
    ...
    QLabel*         m_lbl_temp;
    QLabel*         m_lbl_tint;
    QLabel*         m_lbl_videoStitch;
    QLabel*         m_lbl_videoShow;
...
signals:
    ...
    void imgCallback(int outW, int outH, int posX, int posY, eImageproStitchQuality quality, float sharpness, int bUpdate);
