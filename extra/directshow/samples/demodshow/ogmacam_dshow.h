...
typedef void (__stdcall* PIOGMACAM_EXPOSURE_CALLBACK)(void* ctxExpo);                                  /* exposure time or gain changed */
...
#define __IOGMACAM_DEFINED__
    /* Both the DirectShow source filter and the output pin(s) support this interface.
        That is to say, you can use QueryInterface on the filter or the pin(s) to get the IOgmacam interface.
    */
    // {66B8EAB5-B594-4141-95FC-691A81B445F6}
    DEFINE_GUID(IID_IOgmacam, 0x66b8eab5, 0xb594, 0x4141, 0x95, 0xfc, 0x69, 0x1a, 0x81, 0xb4, 0x45, 0xf6);

    DECLARE_INTERFACE_(IOgmacam, IUnknown)
    {
        /*
        ...
        */
        ...
        STDMETHOD(GetHistogram) (THIS_ PIOGMACAM_HISTOGRAM_CALLBACK funHistogram, void* ctxHistogram) PURE;
        STDMETHOD(put_ExpoCallback) (THIS_ PIOGMACAM_EXPOSURE_CALLBACK funExpo, void* ctxExpo) PURE;
        ...
        */
        ...
        STDMETHOD(AwbInit) (THIS_ PIOGMACAM_WHITEBALANCE_CALLBACK funWB, void* ctxWB) PURE;
        ...
        */
        ...
        STDMETHOD(put_ChromeCallback) (THIS_ PIOGMACAM_CHROME_CALLBACK funChrome, void* ctxChrome) PURE;
        ...
        STDMETHOD(AwbOnce) (THIS_ PIOGMACAM_TEMPTINT_CALLBACK funTT, void* ctxTT) PURE; /* Auto White Balance, Temp/Tint Mode */
        ...
        */ 
        ...
        /*
            OGMACAM_OPTION_xxxx, see ogmacam.h
        */
        ...
        STDMETHOD(AbbOnce) (THIS_ PIOGMACAM_BLACKBALANCE_CALLBACK funBB, void* ctxBB) PURE;
        ...
        */
        ...
        STDMETHOD(get_FfcStatus) (THIS_ int* status) PURE; /* see OGMACAM_OPTION_FFC */
        STDMETHOD(put_FfcStatus) (THIS_ int status) PURE;
        
        STDMETHOD(IoControl)(unsigned ioLineNumber, unsigned nType, int outVal, int* inVal) PURE;
        
        /* Dark Field Correction */
        STDMETHOD(DfcOnce) (THIS_) PURE;
        STDMETHOD(get_DfcStatus) (THIS_ int* status) PURE; /* see OGMACAM_OPTION_DFC */
...
#ifndef __IOGMACAMSTILLIMAGE_DEFINED__
#define __IOGMACAMSTILLIMAGE_DEFINED__
    ...
    */
    ...
    DEFINE_GUID(IID_IOgmacamStillImage, 0xe978eea0, 0xa0ff, 0x465f, 0xab, 0x35, 0x65, 0x90, 0x7b, 0x8c, 0x62, 0xac);
    
    DECLARE_INTERFACE_(IOgmacamStillImage, IUnknown)
    {
        /*
...
#ifndef __IOGMACAMSERIALNUMBER_DEFINED__
#define __IOGMACAMSERIALNUMBER_DEFINED__
    // {E12D4B13-333F-4eae-BC89-0446D1FC634D}
    DEFINE_GUID(IID_IOgmacamSerialNumber, 0xe12d4b13, 0x333f, 0x4eae, 0xbc, 0x89, 0x4, 0x46, 0xd1, 0xfc, 0x63, 0x4d);
    
    DECLARE_INTERFACE_(IOgmacamSerialNumber, IUnknown)
    {
...
#ifndef __IOGMACAMVERSION_DEFINED__
#define __IOGMACAMVERSION_DEFINED__

    // {FC69B0C7-6140-4FE7-B385-473E5EA87887}
    DEFINE_GUID(IID_IOgmacamVersion, 0xfc69b0c7, 0x6140, 0x4fe7, 0xb3, 0x85, 0x47, 0x3e, 0x5e, 0xa8, 0x78, 0x87);
    
    DECLARE_INTERFACE_(IOgmacamVersion, IUnknown)
    {
...
#define __IOGMACAMST4_DEFINED__
    ...
    DEFINE_GUID(IID_IOgmacamST4, 0x29867037, 0x78a9, 0x432f, 0xbf, 0x33, 0xa3, 0xcf, 0xe0, 0xd6, 0xc9, 0xb3);
    
    DECLARE_INTERFACE_(IOgmacamST4, IUnknown)
    {
...
static void InitAx(const wchar_t* clsid)
{
    ...
    if (ERROR_SUCCESS == RegOpenKeyExW(HKEY_CLASSES_ROOT, regPath, 0, KEY_READ, &hKey))
    {
        ...
        if (ERROR_SUCCESS == RegQueryValueExW(hKey, NULL, NULL, NULL, (PBYTE)axPath, &cbData)) /* query the full path of ogmacam.ax */
        {
...
void InitAxMicro()
{
    /* {EA6387A5-60C7-41D3-B058-8D90580A7BE1} is the clsid of ogmacam micro dshow object */
    InitAx(L"{EA6387A5-60C7-41D3-B058-8D90580A7BE1}");
}

void InitAxAstro()
{
    /* {B2190DBF-21E3-4580-98B2-0DB1E557A027} is the clsid of ogmacam astro dshow object */
