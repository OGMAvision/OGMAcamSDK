...
#define OGMACAM_FLAG_GIGE                0x0000200000000000  /* GigE */
#define OGMACAM_FLAG_10GIGE              0x0000400000000000  /* 10 Gige */
...
#define OGMACAM_BLACKLEVEL8_MAX          31              /* maximum black level for bit depth = 8 */
#define OGMACAM_BLACKLEVEL10_MAX         (31 * 4)        /* maximum black level for bit depth = 10 */
#define OGMACAM_BLACKLEVEL12_MAX         (31 * 16)       /* maximum black level for bit depth = 12 */
#define OGMACAM_BLACKLEVEL14_MAX         (31 * 64)       /* maximum black level for bit depth = 14 */
#define OGMACAM_BLACKLEVEL16_MAX         (31 * 256)      /* maximum black level for bit depth = 16 */
...
#define OGMACAM_TEC_TARGET_MIN           (-300)  /* TEC target: -30.0 degrees Celsius */
...
#define OGMACAM_NOPACKET_TIMEOUT_MIN     500     /* 500ms */
#define OGMACAM_NOFRAME_TIMEOUT_MIN      500     /* 500ms */
...
#define OGMACAM_EVENT_IMAGE             0x0004    /* live image arrived, use Ogmacam_PullImage to get this image */
#define OGMACAM_EVENT_STILLIMAGE        0x0005    /* snap (still) frame arrived, use Ogmacam_PullStillImage to get this frame */
...
#define OGMACAM_EVENT_AFFEEDBACK        0x0083    /* auto focus feedback information */
...
/*  for pull mode: OGMACAM_EVENT_STILLIMAGE, and then Ogmacam_PullStillImageXXXX/Ogmacam_PullImageV3
...
OGMACAM_API(HRESULT)  Ogmacam_get_MaxBitDepth(HOgmacam h); /* get the max bit depth of this camera, such as 8, 10, 12, 14, 16 */
...
/* discard the current internal frame cache.
    ...
    Ogmacam_Flush is obsolete, it's a synonyms for Ogmacam_put_Option(h, OGMACAM_OPTION_FLUSH, 3)
*/
OGMACAM_DEPRECATED
...
#define OGMACAM_OPTION_NOFRAME_TIMEOUT        0x01       /* no frame timeout: 0 => disable, positive value (>= 500) => timeout milliseconds. default: disable */
...
#define OGMACAM_OPTION_RAW                    0x04       /* raw data mode, read the sensor "raw" data. This can be set only BEFORE Ogmacam_StartXXX(). 0 = rgb, 1 = raw, default value: 0 */
...
#define OGMACAM_OPTION_TRIGGER                0x0b       /* 0 = video mode, 1 = software or simulated trigger mode, 2 = external trigger mode, 3 = external + software trigger, default value = 0 */
...
#define OGMACAM_OPTION_CG                     0x19       /* Conversion Gain: 0 = LCG, 1 = HCG, 2 = HDR */
...
#define OGMACAM_OPTION_AFMODE                 0x25       /* auto focus mode (0:manul focus; 1:auto focus; 2:once focus; 3:conjugate calibration) */
#define OGMACAM_OPTION_AFZONE                 0x26       /* auto focus zone */
#define OGMACAM_OPTION_AFFEEDBACK             0x27       /* auto focus information feedback; 0:unknown; 1:focused; 2:focusing; 3:defocus; 4:up; 5:down */
...
#define OGMACAM_OPTION_NOPACKET_TIMEOUT       0x2b       /* no packet timeout: 0 = disable, positive value = timeout milliseconds. default: disable */
...
#define OGMACAM_OPTION_PRECISE_FRAMERATE      0x2d       /* precise frame rate current value in 0.1 fps */
...
#define OGMACAM_OPTION_CALLBACK_THREAD        0x30       /* dedicated thread for callback */
...
OGMACAM_API(HRESULT)  Ogmacam_get_AfParam(HOgmacam h, OgmacamAfParam* pAfParam);
...
#define OGMACAM_IOCONTROLTYPE_GET_INPUTACTIVATION         0x09 /* 0x00 => Positive, 0x01 => Negative */
...
/*
    ...
    when nBitDepth > 8
        nBitCount:  24 => RGB24
                    ...
                    64 => RGB64
*/
OGMACAM_API(void)     Ogmacam_deBayerV2(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth, unsigned char nBitCount);

/*
    obsolete, please use Ogmacam_deBayerV2
*/
OGMACAM_DEPRECATED
OGMACAM_API(void)     Ogmacam_deBayer(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth);

typedef void (__stdcall* POGMACAM_DEMOSAIC_CALLBACK)(unsigned nFourCC, int nW, int nH, const void* input, void* output, unsigned char nBitDepth, void* ctxDemosaic);
...
/* Ogmacam_FfcOnePush is obsolete, it's a synonyms for Ogmacam_FfcOnce. */
OGMACAM_DEPRECATED
OGMACAM_API(HRESULT)  Ogmacam_FfcOnePush(HOgmacam h);

/* Ogmacam_DfcOnePush is obsolete, it's a synonyms for Ogmacam_DfcOnce. */
OGMACAM_DEPRECATED
OGMACAM_API(HRESULT)  Ogmacam_DfcOnePush(HOgmacam h);

/* Ogmacam_AwbOnePush is obsolete, it's a synonyms for Ogmacam_AwbOnce. */
OGMACAM_DEPRECATED
OGMACAM_API(HRESULT)  Ogmacam_AwbOnePush(HOgmacam h, PIOGMACAM_TEMPTINT_CALLBACK funTT, void* ctxTT);

/* Ogmacam_AbbOnePush is obsolete, it's a synonyms for Ogmacam_AbbOnce. */
OGMACAM_DEPRECATED
...
*/
typedef void (*POGMACAM_HOTPLUG)(void* ctxHotPlug);
#if !defined(_WIN32) && !defined(__ANDROID__)
OGMACAM_API(void)   Ogmacam_HotPlug(POGMACAM_HOTPLUG funHotPlug, void* ctxHotPlug);
#endif

#if defined(_WIN32)
/* Ogmacam_put_TempTintInit is obsolete, it's a synonyms for Ogmacam_AwbOnce. */
OGMACAM_DEPRECATED
...
/* obsolete, please use Ogmacam_put_Roi and Ogmacam_get_Roi */
OGMACAM_DEPRECATED
